...
urlpatterns = [
    ...
    path('developer/operation-logs/', developer_views.operation_logs, name='pipecloud-developer-operation-logs'),
    ...
    path('initialization/cancel/', workflow_views.cancel_initialization, name='pipecloud-initialization-cancel'),
    ...
    path('anti-corrosion/cutting-visualization/', workflow_views.anti_corrosion_cutting_visualization, name='pipecloud-anti-corrosion-cutting-visualization'),
    path('welding/pre-schedule/', workflow_views.welding_pre_schedule_rows, name='pipecloud-welding-pre-schedule-rows'),
    path('material-locking/pre-schedule/', workflow_views.material_locking_rows, name='pipecloud-material-locking-rows'),
    path('material-locking/release/', workflow_views.release_material_locking, name='pipecloud-material-locking-release'),
